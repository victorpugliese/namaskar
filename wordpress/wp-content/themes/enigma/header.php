	...
	<div class="" style="background-color: #FFFFFF; ">		
		<div class="container" >
			...
			<?php } ?>
				...
				<ul class="head-contact-info" style="color: #000000">
						<?php if($wl_theme_options['email_id'] !='') { ?><li><i class="fa fa-envelope"></i><a style="color: #000000" href="mailto:<?php echo esc_attr($wl_theme_options['email_id']); ?>"><?php echo esc_attr($wl_theme_options['email_id']); ?></a></li><?php } ?>
						<?php if($wl_theme_options['phone_no'] !='') { ?><li><i class="fa fa-phone"></i><a style="color: #000000" href="tel:<?php echo esc_attr($wl_theme_options['phone_no']); ?>"><?php echo esc_attr($wl_theme_options['phone_no']); ?></a></li><?php } ?>
				</ul>
				<?php } ?>
					<ul class="social">
					<?php if($wl_theme_options['fb_link']!='') { ?>
					   <li class="facebook" data-toggle="tooltip" data-placement="bottom" title="Facebook" style='background-color: #3b5998'><a  href="<?php echo esc_url($wl_theme_options['fb_link']); ?>"><i class="fab fa-facebook-f"></i></a></li>
					...
					<li class="youtube" data-toggle="tooltip" data-placement="bottom" title="Youtube" style='background-color: #c4302b'><a href="<?php echo esc_url($wl_theme_options['youtube_link']) ; ?>"><i class="fab fa-youtube"></i></a></li>
					...
					<li class="instagram" data-toggle="tooltip" data-placement="bottom" title="instagram" style='background-color: #ff6633'><a href="<?php echo esc_url($wl_theme_options['instagram']) ; ?>"><i class="fab fa-instagram"></i></a></li>
					...
					<li class="linkedin" data-toggle="tooltip" data-placement="bottom" title="whatsapp" style='background-color: #34af23'><a href="tel:<?php echo esc_attr($wl_theme_options['whatsapp_link']) ; ?>"><i class="fab fa-whatsapp"></i></a></li>
	                <?php } ?>
